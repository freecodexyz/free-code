...
write_manifest() {
  local manifest_dir="$HOME/.claude"
  local manifest_file="$manifest_dir/install-manifest.txt"
  mkdir -p "$manifest_dir"

  cat > "$manifest_file" << EOF
# free-code install manifest - generated by install.sh
# This file is used by uninstall.sh to remove all installed files.
# Do not edit manually.
$HOME/free-code/
$HOME/.local/bin/free-code
$HOME/.claude/install-manifest.txt
EOF
